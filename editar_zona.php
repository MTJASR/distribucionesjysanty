...
<?php include_once "includes/header.php"; ?>
                ...
                <div class="page-content-wrapper ">
                    ...
                    <?php
                        ...
                        $sentencia = $bd->prepare("SELECT * FROM tb_usuarios where id = ?;");
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h5 class="page-title">Editar La Zona Del Vendedor <?php echo $usuario->nombre; ?> </h5>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="editar_proceso_zona.php" method="post">
                                            <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-2 col-form-label">Zona</label>
                                                <div class="col-sm-10">
                                                    <input style="text-transform:uppercase;" class="form-control u" type="text" name="sona" placeholder="Coloque la zona que le corresponde al vendedor" id="example-url-input"
                                                    value="<?php echo $usuario->sona; ?>">
