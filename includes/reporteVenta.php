...
<p style="text-align:center">PRODUCTOS ADQUIRIDOS POR CLIENTE</p>
</div>
<br>
...
$sql_pro = "SELECT p.proveedor_fk  FROM ventas v
LEFT JOIN detalle_venta d ON d.id_venta=v.id
LEFT JOIN tb_productos p ON p.id=d.id_producto
where DATE(v.fecha) = :fecha group by p.proveedor_fk";
//articulos
