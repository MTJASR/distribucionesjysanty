...
<?php include_once "includes/header.php"; ?>
                ...
                <div class="page-content-wrapper ">
                    ...
                    <div class="container-fluid">
                        ...
                        $sentencia = $bd->prepare("SELECT * FROM tb_categoria where id = ?;");
                            ...
                            <div class="col-12">
                                <div class="card m-b-30">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="editar_proceso_categoria.php" method="post">
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label">NOMBRE</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="nombre_cat" placeholder="NOMBRE DEL PRODUCTO" id="example-text-input" require
