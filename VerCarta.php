...
<div class="panel-body">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo '$'.$item["prc_venta_1"].' USD'; ?></td>
            <td><input type="number" disabled class="form-control text-center" value="<?php echo $item["qty"]; ?>" onchange="updateCartItem(this, '<?php echo $item["rowid"]; ?>') " ></td>
