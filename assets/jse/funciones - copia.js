        ...
        success: function (response) {
            ...
            if (response == 'sumado') {
                Swal.fire({
                    position: 'top-center',
                    icon: 'success',
                    title: 'Se agrego cantidad al producto',
...
function listar() {
  ...
  <button class="mas btn btn-danger btn-sm" op="menos" can="${row['cantidad']}" idd="${row['id']}" type="button">-</button>
  <div class="input-group-append">
    <span class="input-group-text">${row['cantidad']}</span>
    
  </div>
  <div class="input-group-append">
	<button class="mas btn btn-primary btn-sm" op="mas" can="${row['cantidad']}" idd="${row['id']}" type="button">+</button>
  </div>
</div>
				</td>
